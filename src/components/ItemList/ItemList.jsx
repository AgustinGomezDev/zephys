...
export const ItemList = ({products}) => {
    return (
        <div>
            <h2 className="text-center text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-pink-300 to-purple-900 leading-tight">¡Welcome to Zephys!</h2>
