    ...
    return (
        <div className="min-h-screen">
            { products.length === 0
                ...
                : <h2 className="text-center text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-pink-300 to-purple-900 leading-tight">¡Take a look at what we have for you!</h2>
            }
