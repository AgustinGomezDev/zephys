    ...
    return (
        <div className="mt-3 flex items-center gap-5">
            <div>
                ...
                <button onClick={handleSubtract} className="block w-20 font-bold text-white bg-red-500 hover:border-red-200 active:bg-red-800 focus:outline-none">-</button>
                <p className="font-bold text-xl block w-5 text-center">{amount}</p>
                <button onClick={handleAdd} className="block w-20 font-bold text-white bg-green-600 hover:border-green-200 active:bg-green-800 focus:outline-none">+</button>
                </div>
            </div>
